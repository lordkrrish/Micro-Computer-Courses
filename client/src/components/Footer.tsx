...
export function Footer() {
  ...
  return (
    <footer className="bg-black/80 border-t border-white/10 py-6 backdrop-blur-lg relative">
      <div className="container mx-auto px-4 relative flex justify-center items-center">
        ...
        {location === "/" && (
          ...
          >
            <div className="px-3 py-1 bg-white/5 rounded-md border border-white/10 backdrop-blur-sm">
